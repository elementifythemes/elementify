...
class Assets {
	...
	public function frontend_assets() {
		...
		wp_enqueue_style(
			'elementify-main',
			trailingslashit( ELEMENTIFY_DIR_URI ) . 'assets/build/public/index.css',
			[],
			filemtime( ELEMENTIFY_DIR_PATH . '/assets/build/public/index.css' ),
			'all'
		);
		...
		wp_enqueue_script(
			'elementify-main',
			trailingslashit( ELEMENTIFY_DIR_URI ) . 'assets/build/public/index.js',
			[],
			filemtime( ELEMENTIFY_DIR_PATH . '/assets/build/public/index.js' ),
			true
		);
	...
	public function customize_preview_assets() {
		...
		wp_enqueue_script(
			...
			trailingslashit( ELEMENTIFY_DIR_URI ) . 'assets/build/customizer/index.js',
			['customize-preview'],
			filemtime( ELEMENTIFY_DIR_PATH . '/assets/build/customizer/index.js' ),
			true
		);
