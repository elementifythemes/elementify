...
if ( ! defined( 'ELEMENTIFY_BUILD_URI' ) ) {
	define( 'ELEMENTIFY_BUILD_URI', untrailingslashit( get_template_directory_uri() ) . '/assets/build' );
}

if ( ! defined( 'ELEMENTIFY_BUILD_PATH' ) ) {
	define( 'ELEMENTIFY_BUILD_PATH', untrailingslashit( get_template_directory() ) . '/assets/build' );
}

if ( ! defined( 'ELEMENTIFY_BUILD_JS_URI' ) ) {
	define( 'ELEMENTIFY_BUILD_JS_URI', untrailingslashit( get_template_directory_uri() ) . '/assets/build/js' );
}

if ( ! defined( 'ELEMENTIFY_BUILD_JS_DIR_PATH' ) ) {
	define( 'ELEMENTIFY_BUILD_JS_DIR_PATH', untrailingslashit( get_template_directory() ) . '/assets/build/js' );
}

if ( ! defined( 'ELEMENTIFY_BUILD_IMG_URI' ) ) {
	define( 'ELEMENTIFY_BUILD_IMG_URI', untrailingslashit( get_template_directory_uri() ) . '/assets/build/src/img' );
}

if ( ! defined( 'ELEMENTIFY_BUILD_CSS_URI' ) ) {
	define( 'ELEMENTIFY_BUILD_CSS_URI', untrailingslashit( get_template_directory_uri() ) . '/assets/build/css' );
}

if ( ! defined( 'ELEMENTIFY_BUILD_CSS_DIR_PATH' ) ) {
	define( 'ELEMENTIFY_BUILD_CSS_DIR_PATH', untrailingslashit( get_template_directory() ) . '/assets/build/css' );
}

if ( ! defined( 'ELEMENTIFY_BUILD_LIB_URI' ) ) {
	define( 'ELEMENTIFY_BUILD_LIB_URI', untrailingslashit( get_template_directory_uri() ) . '/assets/build/library' );
}
